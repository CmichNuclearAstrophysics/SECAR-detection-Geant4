...
ActionInitialization::ActionInitialization(AnalysisManager* analysisMan, DetectorConstruction* detectorMan)
 :G4VUserActionInitialization()
{
 analysis = analysisMan;
 detector = detectorMan;
}
...
EventAction* event = new EventAction(analysis, detector);
SetUserAction(event); 
