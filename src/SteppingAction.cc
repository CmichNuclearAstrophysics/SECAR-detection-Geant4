...
{ 
  ...
  //{
    ...
    if(Z==0&&A==1) { // check for neutrons
      theta_n_tar = tarDirection.theta()*57.2958;
      ekin_n_tar = tarEkin;
    ...
    //if(Z!=36) {
    fEventAction->AddTarget(Z, A, tarEkin, tarEdep, hitTarPos, tarDirection, stripEkin, hitStripPos, stripDirection, tarToF, ekin_n_tar, theta_n_tar); }
  }
